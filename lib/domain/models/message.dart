...
class Message {
  ...
  // ============================================================
  // 4. ПОЛЯ ДЛЯ БУДУЩЕГО (пока не используются, но модель готова)
  // ============================================================
  ...
  // ------------------------------------------------------------
  // 5.1. Создание сообщения из SSE-потока (НОВОЕ!)
  // ------------------------------------------------------------
  ...
  // ------------------------------------------------------------
  // 5.2. Создание сообщения пользователя (УДОБНЫЙ МЕТОД)
  // ------------------------------------------------------------

  /// Удобный конструктор для быстрого создания сообщения пользователя.
  ///
  /// [attachments] — файлы, прикреплённые к этому сообщению. По умолчанию
  /// пусто. Используется UI, чтобы показать превью прикреплённых файлов
  /// прямо в истории сообщений (а не только в момент отправки).
  ...
  // ------------------------------------------------------------
  // 5.3. Создание сообщения AI (УДОБНЫЙ МЕТОД)
  // ------------------------------------------------------------
  ...
  // ============================================================
  // 6. СЕРИАЛИЗАЦИЯ (преобразование обратно в JSON)
  // ============================================================
